  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center md:justify-end min-h-screen bg-black bg-opacity-40">
        {/* Content Box */}
        <div className="w-full max-w-sm md:max-w-md lg:max-w-lg p-4 md:p-8 bg-[#FFF3E3] bg-opacity-90 rounded-lg shadow-lg text-center md:text-left">
          ...
          <p className="text-sm md:text-base lg:text-lg mb-6 md:mb-8 text-[#333333]">
